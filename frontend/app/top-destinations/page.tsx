      ...
      <section className="py-[60px]">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed">
            <p>
              Selecting your cruise by destination ensures you experience
              exactly what you're looking for in your vacation. Each region
              offers unique attractions, climates, and cultural experiences that
              shape your entire journey.
            </p>
            <p>
              Caribbean cruises provide year-round sunshine, pristine beaches,
              and vibrant island cultures. Alaska cruises showcase glaciers,
              wildlife, and dramatic landscapes. Mediterranean voyages combine
              history, cuisine, and stunning coastal scenery.
            </p>
            <p>
              Consider factors like travel time to ports, seasonal weather
              patterns, and the types of activities you enjoy. Beach lovers
              gravitate toward the Caribbean and Bahamas, while history
              enthusiasts prefer Mediterranean and European itineraries. Alaska
              attracts nature lovers and adventure seekers.
            </p>
            <p>
              All our cruise bookings include maximum onboard credit, giving you
              extra spending money for shore excursions, specialty dining, spa
              treatments, and more. This added value enhances your destination
              experience, allowing you to fully explore each port of call.
            </p>
          </div>
        </div>
      </section>
