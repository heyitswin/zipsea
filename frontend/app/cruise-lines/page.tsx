      ...
      <section className="py-[60px]">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed">
            <p>
              Each cruise line has its own personality, style, and specialties.
              Understanding these differences helps you select the perfect match
              for your vacation preferences and travel companions.
            </p>
            <p>
              Royal Caribbean leads in innovation with features like surf
              simulators, rock climbing walls, and the tallest slides at sea.
              Carnival, known as the "Fun Ships," offers a casual atmosphere
              perfect for families and groups. Norwegian Cruise Line pioneered
              freestyle cruising with no fixed dining times or dress codes.
            </p>
            <p>
              For a more upscale experience, Celebrity Cruises delivers modern
              luxury with award-winning cuisine and contemporary design.
              Princess Cruises excels in destination expertise, particularly in
              Alaska. MSC Cruises brings Mediterranean elegance to seas
              worldwide.
            </p>
            <p>
              Regardless of which cruise line you choose, all Zipsea bookings
              include maximum onboard credit. This added value gives you extra
              spending money for specialty restaurants, beverage packages, spa
              treatments, and shore excursions, enhancing your cruise experience
              no matter which line you sail with.
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full bg-white rounded-[10px] overflow-hidden">
              ...
              <tbody>
                <tr className="border-b border-[#E5E5E5]">
                  ...
                  <td className="px-6 py-4 font-geograph text-[#666]">
                    Innovation, activities, entertainment
                  </td>
                </tr>
                <tr className="border-b border-[#E5E5E5]">
                  <td className="px-6 py-4 font-geograph font-semibold">
                  ...
                  <td className="px-6 py-4 font-geograph text-[#666]">
                    Casual atmosphere, value pricing
                  </td>
                </tr>
                <tr className="border-b border-[#E5E5E5]">
                  <td className="px-6 py-4 font-geograph font-semibold">
                  ...
                  <td className="px-6 py-4 font-geograph text-[#666]">
                    Freestyle cruising, no dress code
                  </td>
                </tr>
                <tr className="border-b border-[#E5E5E5]">
                  <td className="px-6 py-4 font-geograph font-semibold">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 font-geograph text-[#666]">
                    Mediterranean elegance, family-friendly
                  </td>
                </tr>
              </tbody>
            </table>
