      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 bg-gray-50">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-medium">{quote.cruise_line_name} - {quote.ship_name}</p>
            </div>
            <div>
          ...
          {quote.special_requirements && (
            <div className="mt-4">
              ...
              <p className="font-medium text-sm mt-1">{quote.special_requirements}</p>
            </div>
          )}
        </div>
        ...
        <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
          ...
          <button
            ...
            disabled={loading || !prices.some(p => p.cabinCategory && p.price)}
...
export default function AdminQuotes() {
  ...
  const fetchQuotes = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/api/v1/admin/quotes?${params}`);
      if (response.ok) {
