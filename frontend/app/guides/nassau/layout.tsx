...
export const metadata: Metadata = {
  ...
  description:
    "Nassau cruise port guide 2025: beaches, Atlantis passes, dining, transport tips. Everything for your perfect Bahamas port day.",
  keywords:
    "Nassau cruise port, Bahamas cruise guide, Prince George Wharf, Atlantis day pass, Nassau beaches, Paradise Island, Cable Beach, Junkanoo Beach, Nassau shore excursions, Fish Fry Nassau, Straw Market, Nassau cruise terminal, Blue Lagoon Island, Nassau taxi rates, jitney buses Nassau, Queen's Staircase, Nassau cruise tips",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Everything you need to know for your Nassau cruise stop - beaches, Atlantis, dining, shopping, and transportation. Make the most of your Bahamas port day.",
  ...
  twitter: {
    ...
    description:
      "Complete guide to Nassau for cruise passengers - beaches, attractions, dining, and insider tips.",
    images: [
