          ...
          <div className="bg-white rounded-lg p-8 md:p-12 shadow-sm">
            ...
            <div className="relative w-full h-[400px] mb-8 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Aerial view of Prince George Wharf with multiple cruise ships docked"
                fill
            ...
            <div className="prose prose-lg max-w-none">
              ...
              {/* Port Overview */}
              <h2 className="font-whitney font-black uppercase text-[36px] mt-12 mb-6" style={{ color: '#0E1B4D' }}>
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  ...
                  alt="Modern Nassau cruise terminal with shops and restaurants"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Downtown/Bay Street:</strong> 5 minutes of easy, flat walking</li>
                <li><strong>Straw Market:</strong> 7-10 minutes through the port area</li>
                <li><strong>Junkanoo Beach:</strong> 15-minute scenic waterfront stroll westward</li>
                <li><strong>Queen&apos;s Staircase:</strong> 20-minute walk with a gentle uphill climb</li>
              </ul>

              <h3 className="font-geograph font-bold text-[24px] mt-8 mb-4" style={{ color: '#0E1B4D' }}>
                Taxi Services
              </h3>
              <p className="font-geograph text-[16px] leading-relaxed mb-4" style={{ color: '#0E1B4D' }}>
                Official taxis display "TN" plates and operate on a zone-based fare system. Here are the standard rates from the port:
              </p>
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Paradise Island:</strong> $6 per person (couples often pay $11-13 total)</li>
                <li><strong>Cable Beach:</strong> $16-18 for two people</li>
                <li><strong>Atlantis:</strong> Same as Paradise Island plus $2 bridge toll</li>
              </ul>
              <div className="bg-blue-50 p-4 rounded-lg mb-6">
                <p className="font-geograph text-[16px]" style={{ color: '#0E1B4D' }}>
                  <strong>Helpful tip:</strong> Always confirm your fare before departing. Tipping 15% is customary for good service.
                </p>
              </div>
              ...
              <p className="font-geograph text-[16px] leading-relaxed mb-6" style={{ color: '#0E1B4D' }}>
                Experience authentic Bahamian culture for just $1.25 on the colorful jitney buses. The <strong>#10 jitney</strong> runs every 10-15 minutes to Cable Beach. Remember to have exact change ready and pay when exiting the bus. These local buses offer a fun, economical way to travel while enjoying local music and atmosphere.
              </p>

              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1521335629791-ce4aec67dd15?auto=format&fit=crop&w=2000&q=80"
                  alt="Colorful buildings on Bay Street Nassau"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <p className="font-geograph text-[16px] leading-relaxed mb-4" style={{ color: '#0E1B4D' }}>
                The iconic Atlantis Resort draws many visitors to Paradise Island. <strong>Day passes</strong> are available when hotel occupancy permits (typically below 90%), and must be booked at least 48 hours in advance through the resort&apos;s website or your cruise line.
              </p>
              ...
              <div className="bg-green-50 p-4 rounded-lg mb-6">
                <p className="font-geograph text-[16px]" style={{ color: '#0E1B4D' }}>
                  <strong>Alternative option:</strong> Guests at Comfort Suites Paradise Island receive complimentary Atlantis access, which can be more economical for families.
                </p>
              </div>
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  ...
                  alt="Beautiful Bahamas beach with turquoise waters"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                ...
                <p className="font-geograph text-[16px] mb-2" style={{ color: '#0E1B4D' }}>
                  <strong>Features:</strong> Lively atmosphere, food vendors, beach chair rentals
                </p>
                <p className="font-geograph text-[16px]" style={{ color: '#0E1B4D' }}>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <p className="font-geograph text-[16px] mb-2" style={{ color: '#0E1B4D' }}>
                  <strong>Distance:</strong> 20-minute ride via taxi ($16-18) or jitney ($1.25)
                </p>
                <p className="font-geograph text-[16px] mb-2" style={{ color: '#0E1B4D' }}>
                  <strong>Features:</strong> Pristine white sand, calm waters, spacious beach area
                </p>
                <p className="font-geograph text-[16px]" style={{ color: '#0E1B4D' }}>
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?auto=format&fit=crop&w=2000&q=80"
                  alt="Aerial view of Blue Lagoon Island crystal waters"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <p className="font-geograph text-[16px] mb-2" style={{ color: '#0E1B4D' }}>
                  <strong>Distance:</strong> 3 miles offshore (ferry from Paradise Island)
                </p>
                <p className="font-geograph text-[16px] mb-2" style={{ color: '#0E1B4D' }}>
                  <strong>Features:</strong> Private island experience with multiple beach areas
                </p>
                <p className="font-geograph text-[16px]" style={{ color: '#0E1B4D' }}>
                  <strong>Cost:</strong> $109+ for adults including ferry, beach access, and lunch
                </p>
              </div>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Queen&apos;s Staircase:</strong> 66 hand-carved steps with historical significance and beautiful surroundings</li>
                <li><strong>Fort Fincastle:</strong> Historic fort with panoramic views of Nassau harbor</li>
                <li><strong>John Watling&apos;s Distillery:</strong> Complimentary rum tours with tastings in a beautifully restored 1789 estate</li>
                <li><strong>Parliament Square:</strong> Distinctive pink colonial buildings that are perfect for photos</li>
              </ul>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Swimming with Dolphins</strong> ($165-235): A memorable encounter at Blue Lagoon Island</li>
                <li><strong>Pirates of Nassau Museum</strong> ($14): Interactive museum bringing pirate history to life</li>
                <li><strong>Graycliff Chocolate Making</strong> ($54.95): Hands-on chocolate making in a historic mansion</li>
              </ul>

              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.pexels.com/photos/5008831/pexels-photo-5008831.jpeg?auto=compress&cs=tinysrgb&w=1600"
                  alt="Dolphins swimming in crystal clear water"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg mb-6">
                ...
                <ol className="font-geograph text-[16px] space-y-2" style={{ color: '#0E1B4D' }}>
                  <li>1. Negotiation is expected – start your offer at about 40-50% of the asking price</li>
                  <li>2. Vendors making items on-site often have the most authentic products</li>
                  <li>3. Bring cash for better bargaining power</li>
                  <li>4. Take your time to browse different stalls for the best selection and prices</li>
                </ol>
              </div>
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1541204696769-3661098e359f?auto=format&fit=crop&w=2000&q=80"
                  alt="Colorful Caribbean style buildings and restaurants"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Twin Brothers:</strong> Famous for perfectly seasoned conch fritters</li>
                <li><strong>Oh Andros:</strong> Excellent cracked conch with traditional sides</li>
                <li><strong>Drifter&apos;s:</strong> Great atmosphere with live music on Sundays</li>
              </ul>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Bahamian Cookin&apos;:</strong> Family recipes served just 10 minutes from the port</li>
                <li><strong>Potter&apos;s Cay:</strong> Fresh seafood under the Paradise Island bridge</li>
                <li><strong>Pirate Republic Brewing:</strong> Local craft beer at the port area</li>
              </ul>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>Pricing negotiations:</strong> Some vendors may quote high initial prices. Polite bargaining is normal and expected</li>
                <li><strong>Taxi meters:</strong> Taxis don&apos;t use meters – confirm your fare before departing</li>
                <li><strong>Beach vendors:</strong> Can be persistent but a polite "no thank you" usually works</li>
                <li><strong>Tour operators:</strong> Verify credentials and prices before committing to activities</li>
              </ul>
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1521335629791-ce4aec67dd15?auto=format&fit=crop&w=2000&q=80"
                  alt="Busy Bay Street with tourists shopping"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <p className="font-geograph text-[16px] leading-relaxed mb-2" style={{ color: '#0E1B4D' }}>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li>• Morning: Queen&apos;s Staircase and Fort Fincastle tour</li>
                <li>• Lunch: Fish Fry for authentic cuisine</li>
                <li>• Afternoon: Relax at Cable Beach or explore Bay Street shops</li>
              </ul>
              ...
              <ul className="font-geograph text-[16px] space-y-2 mb-6" style={{ color: '#0E1B4D' }}>
                <li><strong>WiFi:</strong> Complimentary throughout the terminal</li>
                <li><strong>Currency:</strong> US dollars accepted everywhere (1:1 with Bahamian dollars)</li>
                <li><strong>ATMs:</strong> Available on Parliament Street</li>
                <li><strong>Shopping:</strong> 60+ stores at the port</li>
                <li><strong>Banking:</strong> Hours typically 9:30am-3pm (Mon-Thu), until 5pm Friday</li>
              </ul>
              ...
              <div className="relative w-full h-[400px] mb-6 rounded-lg overflow-hidden">
                <Image
                  ...
                  alt="Sunset view from cruise ship leaving Nassau"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="mt-12 p-6 rounded-lg text-center" style={{ backgroundColor: '#F7F170' }}>
                ...
                <p className="font-geograph text-[16px] mb-4" style={{ color: '#0E1B4D' }}>
                  Browse thousands of cruises that visit Nassau and get maximum onboard credit with every booking!
                </p>
                <a
                  href="/cruises"
