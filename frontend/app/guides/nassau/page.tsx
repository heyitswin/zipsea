        ...
        <article className="max-w-4xl mx-auto px-8">
          <div className="bg-white rounded-lg p-8 md:p-12 shadow-sm">
            ...
            <div className="relative w-full h-[400px] mb-8 rounded-lg overflow-hidden">
              <Image
                src="https://images.unsplash.com/photo-1547482843-9d6b884af7e0?auto=format&fit=crop&w=2000&q=80"
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1580541831949-61ea79d8f5c0?auto=format&fit=crop&w=2000&q=80"
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1618843479619-f3d19b3deaae?auto=format&fit=crop&w=2000&q=80"
              ...
              <div className="relative w-full h-[300px] mb-6 rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1615571737499-439eb7a594fa?auto=format&fit=crop&w=2000&q=80"
