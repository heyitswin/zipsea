    ...
    <main style={{ backgroundColor: "#F6F3ED" }}>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-8 text-center">
          ...
          <h2 className="font-geograph text-white text-[20px] md:text-[24px] leading-relaxed mb-8 max-w-3xl mx-auto">
            Where the Pacific meets the Sea of Cortez with dramatic rock
            formations, world-class fishing, and vibrant nightlife
          </h2>
        </div>
      </section>
      ...
      <section className="py-[40px] md:py-[60px]">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed">
            <p>
              Cabo San Lucas sits at the southern tip of Mexico's Baja
              California Peninsula, where dramatic desert landscapes meet
              pristine beaches and two bodies of water converge. This tender
              port destination offers everything from iconic landmarks like El
              Arco to world-class sport fishing and vibrant beach clubs.
            </p>
            <p>
              As a tender port, cruise ships anchor in the bay while passengers
              are ferried to the marina. The compact downtown area makes
              exploration easy, with the marina, beaches, and shopping all
              within walking distance or a short water taxi ride away.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed mb-8">
            <p>
              ...
              the bay and passengers are transported to shore via tender boats.
              The tender ride takes approximately 10-15 minutes and drops you at
              the main marina pier.
            </p>
            <p>
              The marina area is immediately walkable upon arrival, with
              restaurants, shops, and tour operators all within a few minutes'
              walk. This central location makes independent exploration
              ...
              <tbody className="font-geograph text-[16px]">
                ...
                <tr className="border-b border-[#E5E5E5]">
                  ...
                  <td className="py-3 px-4">
                    San José del Cabo, remote beaches
                  </td>
                </tr>
                <tr className="border-b border-[#E5E5E5]">
          ...
          <div className="bg-[#0E1B4D] text-white p-6 rounded-lg">
            <p className="font-geograph text-[16px]">
              <strong className="text-[#F7F170]">Tender Priority:</strong> Book
              ship excursions or arrive early at the tender meeting point for
              faster disembarkation. The tender process can take 30-60 minutes
              during peak times.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed mb-8">
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>El Arco (The Arch):</strong> Dramatic rock formation at
                Land's End, accessible by water taxi ($15-20)
              </li>
              <li>
                <strong>Lover's Beach:</strong> Hidden beach accessible only by
                boat near El Arco
              </li>
              <li>
              ...
              <li>
                <strong>Marina Cabo San Lucas:</strong> Luxury yachts,
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed mb-8">
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Sport Fishing:</strong> "Marlin Capital of the World" -
              ...
              <li>
                <strong>Sunset Sailing:</strong> Catamaran cruises with open bar
                ($60-80/person)
              </li>
              <li>
                <strong>Whale Watching:</strong> December-April humpback and
                gray whales ($50-80/person)
              </li>
            </ul>
          </div>
          ...
          <div className="grid gap-4">
            <div className="border-l-4 border-[#F7F170] pl-4">
              ...
              <p className="font-geograph text-[#666]">
                See underwater marine life and iconic rock formations • 45 min •
                $25-35/person
              </p>
            </div>
            <div className="border-l-4 border-[#F7F170] pl-4">
              ...
              <p className="font-geograph text-[#666]">
                Adventure through desert trails to Pacific beaches • 3 hours •
                $80-120/person
              </p>
            </div>
            <div className="border-l-4 border-[#F7F170] pl-4">
              ...
              <p className="font-geograph text-[#666]">
                Learn about and sample premium tequilas • 2 hours •
                $45-65/person
              </p>
            </div>
            <div className="border-l-4 border-[#F7F170] pl-4">
              ...
              <p className="font-geograph text-[#666]">
                Canyon zip lines with ocean views • 3-4 hours • $90-130/person
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-[40px] md:py-[60px]">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed mb-8">
            <p>
              Cabo's culinary scene blends traditional Mexican flavors with
              fresh seafood from both the Pacific and Sea of Cortez. From street
              tacos to upscale dining, the marina area offers options for every
              taste and budget.
            </p>
          </div>
          ...
          <div className="grid gap-4 mb-8">
            <div className="bg-[#FFF8E5] p-4 rounded-lg">
              ...
              <p className="font-geograph text-[#666]">
                Battered or grilled fish with cabbage slaw and crema
              </p>
            </div>
            <div className="bg-[#FFF8E5] p-4 rounded-lg">
              <h4 className="font-geograph font-bold text-[#0E1B4D]">
              ...
              <p className="font-geograph text-[#666]">
                Local delicacy grilled with garlic and lime
              </p>
            </div>
            <div className="bg-[#FFF8E5] p-4 rounded-lg">
              <h4 className="font-geograph font-bold text-[#0E1B4D]">
            ...
            <div className="bg-[#FFF8E5] p-4 rounded-lg">
              ...
              <p className="font-geograph text-[#666]">
                Cabo's signature cocktail with premium tequila
              </p>
            </div>
          </div>
            ...
            <div className="border-b border-[#E5E5E5] pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="font-geograph text-[#666]">
                    Marina views with fresh seafood
                  </p>
                </div>
                <span className="font-geograph text-[#0E1B4D] font-bold">
                  $20-35
            ...
            <div className="border-b border-[#E5E5E5] pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="font-geograph text-[#666]">
                    Sammy Hagar's famous bar with live music
                  </p>
                </div>
                <span className="font-geograph text-[#0E1B4D] font-bold">
                  $15-25
            ...
            <div className="border-b border-[#E5E5E5] pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="font-geograph text-[#666]">
                    Authentic Mexican in colorful courtyard
                  </p>
                </div>
                <span className="font-geograph text-[#0E1B4D] font-bold">
                  $12-20
            ...
            <div>
              ...
              <ul className="space-y-3 font-geograph text-[#666]">
                <li className="flex items-start">
                  <span className="text-[#F7F170] mr-2">▸</span>
                  <span>
                    <strong>Glass Bottom Boat:</strong> Kid-friendly marine
                    viewing
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="text-[#F7F170] mr-2">▸</span>
                  <span>
                    <strong>Wild Canyon:</strong> Zip lines and bridges
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F7F170] mr-2">▸</span>
        ...
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="grid gap-6">
            <div className="bg-[#FFF8E5] p-6 rounded-lg">
              ...
              <p className="font-geograph text-[#666]">
                US dollars widely accepted everywhere. Pesos offer slightly
                better value. ATMs available at marina. Credit cards accepted at
                most establishments. Small bills recommended for tips and taxis.
              </p>
            </div>
            ...
            <div className="bg-[#FFF8E5] p-6 rounded-lg">
              ...
              <p className="font-geograph text-[#666]">
                Beach vendors and time-share salespeople are persistent but
                harmless. A polite "no gracias" usually works. Negotiate prices
                for souvenirs - start at 50% of asking price.
              </p>
            </div>
            ...
            <div className="bg-[#F7F170] p-6 rounded-lg">
              ...
              <p className="font-geograph text-[#0E1B4D] font-bold">
                Pacific side beaches have dangerous rip currents and are not
                safe for swimming. Stick to Medano Beach or protected bays on
            ...
            <div className="bg-[#FFF8E5] p-6 rounded-lg">
              ...
              <p className="font-geograph text-[#666]">
                Year-round sunshine with 350+ days of sun. October-May: Perfect
                weather, whale watching season. June-September: Hot and humid
                with occasional brief showers. Water temperature: 72-82°F
                year-round.
              </p>
            </div>
      ...
      <section className="py-[60px] md:py-[80px] bg-[#0E1B4D]">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <p className="font-geograph text-white text-[20px] mb-8">
            Book your Mexican Riviera cruise with Zipsea and receive maximum
            onboard credit
          </p>
          <Link
      ...
      <section className="py-[40px] md:py-[60px]">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-4 font-geograph text-[18px] text-[#666] leading-relaxed">
            <p>
              Cabo San Lucas offers the perfect blend of natural beauty,
              adventure, and relaxation at the tip of Baja California. From the
              iconic El Arco to world-class fishing, pristine beaches to vibrant
              nightlife, this tender port delivers memorable experiences for
              every type of cruiser.
            </p>
            <p>
              Whether you're snorkeling at Pelican Rock, sipping margaritas on
              Medano Beach, sportfishing in the "Marlin Capital," or exploring
              the marina's restaurants and shops, Cabo provides an authentic
              taste of Mexico's Pacific coast charm.
            </p>
            <p className="font-bold text-[#0E1B4D]">
              Remember: All Zipsea cruise bookings include maximum onboard
              credit for shore excursions, specialty dining, and shopping at the
              marina!
            </p>
          </div>
        </div>
