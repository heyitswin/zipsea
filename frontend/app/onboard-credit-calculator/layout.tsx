...
export const metadata: Metadata = {
  ...
  description: 'Calculate how to spend your onboard credit wisely. Plan your cruise budget for specialty dining, spa services, excursions, beverages, and more across major cruise lines.',
  alternates: {
    canonical: 'https://www.zipsea.com/onboard-credit-calculator',
  },
  openGraph: {
    title: 'Onboard Credit Calculator - Plan Your Cruise Spending',
    description: 'Free tool to help you plan how to use your onboard credit for maximum value on your cruise.',
