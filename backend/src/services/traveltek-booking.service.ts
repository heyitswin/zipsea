...
class TraveltekBookingService {
  ...
  /**
   * Get specific cabins for a cabin grade
   *
   * This is called when user wants to see available specific cabins
   * instead of selecting a guaranteed cabin grade.
   *
   * @param params - Cabin grade parameters (resultNo, gradeNo, rateCode from pricing response)
   * @returns List of specific cabins with details
   */
