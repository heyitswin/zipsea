...
async function seedDatabase() {
    try {
        ...
        await connection_1.db.insert(schema_1.cruiseLines).values(cruiseLineData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${cruiseLineData.length} cruise lines`);
        // Seed regions
        const regionData = [
        ...
        await connection_1.db.insert(schema_1.regions).values(regionData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${regionData.length} regions`);
        // Seed ports
        const portData = [
            {
                id: 1,
        ...
        await connection_1.db.insert(schema_1.ports).values(portData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${portData.length} ports`);
        // Seed ships
        const shipData = [
            {
                id: 1,
        ...
        await connection_1.db.insert(schema_1.ships).values(shipData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${shipData.length} ships`);
        // Seed sample cruises
        const cruiseData = [
            {
                id: 1001,
        ...
        await connection_1.db.insert(schema_1.cruises).values(cruiseData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${cruiseData.length} cruises`);
        ...
        await connection_1.db.insert(schema_1.cabinCategories).values(cabinCategoryData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${cabinCategoryData.length} cabin categories`);
        // Seed sample pricing
        const pricingData = [
            {
                cruiseId: 1001,
        ...
        await connection_1.db.insert(schema_1.pricing).values(pricingData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${pricingData.length} pricing records`);
        ...
        await connection_1.db.insert(schema_1.cheapestPricing).values(cheapestPricingData).onConflictDoNothing();
        logger_1.default.info(`Seeded ${cheapestPricingData.length} cheapest pricing records`);
