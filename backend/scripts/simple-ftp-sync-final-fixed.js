...
async function ensureShipExists(client, shipId, lineId, data) {
  ...
  `,
    [
      ...
      safeIntegerConvert(shipcontent.maxpassengers || shipcontent.occupancy),
      safeIntegerConvert(shipcontent.totalcrew),
      safeIntegerConvert(shipcontent.length),
      safeIntegerConvert(shipcontent.beam),
      safeIntegerConvert(shipcontent.draft),
      safeIntegerConvert(shipcontent.speed),
      shipcontent.registry || null,
      shipcontent.launched
        ? safeIntegerConvert(new Date(shipcontent.launched).getFullYear())
        : null,
