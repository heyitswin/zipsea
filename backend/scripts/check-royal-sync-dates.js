...
async function checkRoyalCaribbeanSyncDates() {
  try {
    ...
    if (aug31Updates[0]?.count > 0) {
      console.log(`Found ${aug31Updates[0].count} cruises updated on Aug 31`);
      console.log(`First update: ${aug31Updates[0].first_update}`);
      console.log(`Last update: ${aug31Updates[0].last_update}`);
    } else {
